...
class OtherAgentsStatesSensor(Sensor):
    ...
    def sense(self, agents, agent_index):
        ...
        other_agents_states_sorted = self.closest_agent_first(other_agents_states) # todo sorting how to provide goals also in params sensor

        self.other_agents_states = other_agents_states_sorted[:self.max_num_other_agents_observed,:-1]
        self.other_agents_states = other_agents_states[:self.max_num_other_agents_observed, :-1]
